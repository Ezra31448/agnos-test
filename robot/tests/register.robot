...
Resource          ../resources/pages/sign_up.robot
...
TC-REG-005 Verify Password Criteria No Uppercase Letter
    ...
    [Tags]    Negative    Regression
    Ensure On Sign Up Page
    Enter Password And Trigger Validation    ${REG_NO_UPPERCASE_PASSWORD}    tc05@gmail.com
...
TC-REG-006 Verify Password Criteria No Digit
    ...
    [Tags]    Negative    Regression
    Ensure On Sign Up Page
    Enter Password And Trigger Validation    ${REG_NO_DIGIT_PASSWORD}    tc06@gmail.com
...
TC-REG-007 Verify Password Criteria No Special Character
    ...
    [Tags]    Negative    Smoke    Regression
    Ensure On Sign Up Page
    Enter Password And Trigger Validation    ${REG_NO_SPECIAL_PASSWORD}    tc07@gmail.com
...
TC-REG-008 Verify Confirm Password Mismatch
    ...
    [Tags]    Negative
    Ensure On Sign Up Page
    Fill Sign Up Form    tc08@gmail.com    ${REG_VALID_PASSWORD}    ${REG_MISMATCH_CONFIRM}
...
TC-REG-009 Verify Password Visibility Toggle
    ...
    [Tags]    Negative
    Ensure On Sign Up Page
    Input Password    ${SIGNUP_PASSWORD_INPUT}    Somtum@2026
...
TC-REG-010 Verify Registration Fails With Already Registered Email
    ...
    Ensure On Sign Up Page
    Register With Valid Data    ${REG_VALID_EMAIL}    ${REG_VALID_PASSWORD}
    Wait Until Element Is Visible    xpath://*[contains(text(),'already') or contains(text(),'exist') or contains(text(),'use')]    timeout=10s
    Page Should Contain Element    xpath://*[contains(text(),'already') or contains(text(),'exist') or contains(text(),'use')]
